...
## Modularisierung {#sec-modularisierung}
...
@fig-label-funktionssicht zeigt beispielhaft vereinfacht eine Sichten auf die Funktionsbausteine einer Hochvoltbatterie.
...
Neben den Sichten, die sich ausschließlich auf das Produkt beziehen existieren weitere Sichten, die z.B. den Produktionsprozess des Produkts einschließen. @fig-label-produktionssicht zeigt als Beispiel eine Sicht auf eine mögliche Produktionsabfolge der Hochvoltbatterie. 
...
::: {.callout-tip}
## Pro-Tipp!
Das Top-Down-Vorgehen hat sich in der Praxis oftmals als das erfolgreichere der beiden Vorgehensweisen erwiesen. Im Zweifel sei dem geneigten Leser geraten mit dem [**Top-Down-Vorgehen**](https://de.wikipedia.org/wiki/Top-down_und_Bottom-up) zu beginnen!
:::
